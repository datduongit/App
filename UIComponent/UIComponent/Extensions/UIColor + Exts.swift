...
extension UIColor {
    ...
    public func toHex(hasPrefix: Bool = false, hasAlpha: Bool = false) -> String {
        guard
            let comps = cgColor.components
        else { fatalError("Could not generate this color to hex string") }
        
        let compsCount = cgColor.numberOfComponents
        let r: Int
        let g: Int
        var b: Int
